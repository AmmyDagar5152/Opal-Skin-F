...
export default function TextOver() {
  ...
  return (
    <section className="relative h-screen min-h-162.5 w-full overflow-hidden bg-black text-white">
      {/* =====================================================
          BACKGROUND VIDEO
      ===================================================== */}
  ...
  {activeExperience.mediaType === "image" ? (
    <motion.img
    ...
    />
        ...
        {/* Bottom gradient */}
        <div className="absolute inset-x-0 bottom-0 h-[55%] bg-linear-to-t from-black/75 via-black/20 to-transparent" />

        {/* Subtle top gradient */}
        <div className="absolute inset-x-0 top-0 h-[25%] bg-linear-to-b from-black/30 to-transparent" />
      </div>
        ...
        <div className="w-full">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="mb-8 md:absolute md:bottom-28 md:left-10 md:mb-0 md:max-w-70"
            >
              <p className="desc-font text-2xl tracking-wide text-white md:text-3xl">
                {activeExperience.title}
              </p>

              <p className="mt-2 max-w-65 outfit text-[11px] leading-relaxed text-white/65 md:text-xs">
            ...
            {experiences.map((experience, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Subtitle */}
                  <span
                    className={`mt-1 block max-w-55 outfit text-[10px] leading-relaxed transition-colors duration-500 md:text-xs ${
